...
def run_1():
    ...
    chassis.straight(-230, then=Stop.NONE)
    ...
    till_black_right(100, 0)
    chassis.turn(30)
    # to team mission
    follow_line(38, 1.99, sensor_right, "right", kp=1.6)
    follow_line_until_black(30, sensor_right, sensor_left)
    chassis.straight(45)
    arm_right.run_time(1000, 1300, wait=False)
    chassis.turn(-70)
    ...
    chassis.straight(550,then= Stop.NONE)
